...
• Supports static + animated (.webm)`
        ...
        try {
            ...
            if (!packRes.data.ok) {
                await react('❌');
                return reply('❌ Pack not found. Check the link.');
            }
...
✔️ Stickers: *${sent}* | ❌ Failed: *${failed}*`
    ...
    chunkPackId
                    ...
                    await reply(`❌ Pack ${packNum + 1} failed: ${err.message}`);
                }
            ...
            return sock.sendMessage(from, {
    text: `✅ *Successfully Done!*
✔️ Stickers: *${totalSent}* | ❌ Failed: *${totalFailed}*`
});
