...
registerRichModule("post", async (builder) => {
  builder.addPost({
    ...
    post_caption: "A major AI Bubble UI update for ALI-MD!",
    likes_count: 24500,
    comments_count: 250,
    shares_count: 1200,
    post_url: "https://github.com/ALI-INXIDE/ALI-MD",
...
registerRichModule("products", async (builder) => {
  builder.addProduct({
    title: "ALI-MD Premium",
    brand: "ALI-MD",
    price: 50000,
    sale_price: 0,
    image_url:
      "https://i.pinimg.com/736x/cf/8f/41/cf8f41dfb65bb723f243d26c86120d4c.jpg",
    product_url: "https://github.com/ALI-INXIDE/ALI-MD",
  });
...
registerRichModule("meta", async (builder) => {
  ...
  builder.setFooter("ғꪮʀ ʏꪮꪊ ғꪮʀ ᴀʟʟ ꪮғ ᴀꜱ 🍉");
});
...
async function sendButtonDemo(Button, sock, from) {
  await new Button(sock)
    ...
    .addUrl("🌐 GitHub", "https://github.com/ALI-INXIDE/ALI-MD", true, {
      icon: "PROMOTION",
    })
    .addCopy("📋 Copy Code", "ALI-MD-2026", { icon: "DOCUMENT" })
          ...
          sections: [
            {
              title: "ALI-MD",
              highlight_label: "",
              rows: [{ header: "", title: "ALI-MD", description: "", id: "" }],
            },
          ],
        }),
      },
