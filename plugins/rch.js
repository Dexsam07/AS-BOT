...
let handler = async (m, { conn, text }) => {
    if (!text) return m.reply("Contoh penggunaan: .rch https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o Hai");

    let args = text.split(" ");
    if (args.length < 2) return m.reply("Format salah! Contoh: .rch https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o Hai");
