...
> Add a number at the end to set image count (max 10, default 5)`
        ...
        try {
            ...
            await react("❌");
            return reply(`❌ *ERROR:* Error occurred while fetching Pinterest images. Please try again later.`);
        }
    },
);
...
>.${botPrefix}spotify sesi potret*`
        ...
        try {
            ...
            await react("❌");
            return reply(`❌ *ERROR:* An error occurred while fetching the Spotify track.`);
        }
    },
);
