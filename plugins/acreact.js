    ...
    if (!Array.isArray(emojis) || emojis.length === 0) {
        return {
            ...
            error:
                ...
                "Example:\n" +
                ".chreact https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o 😂,❤️,🔥",
        };
    }
        ...
        try {
            ...
            if (!q) {
                ...
                return reply(
                    ...
                    `1. Default reactions:\n` +
                    `.chreact https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o\n\n` +

                    `2. Custom emojis:\n` +
                    `.chreact https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o 😂,❤️,🔥\n\n` +

                    `3. Use first 10 servers:\n` +
                    `.chreact https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o 😂,🔥 #10\n\n` +

                    `4. Use specific server:\n` +
                    `.chreact https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o 😂,🔥 &3`
                );
            }
            ...
            if (!isValidChannelPostUrl(url)) {
                ...
                return reply(
                    ...
                    `✅ Correct Format:\n` +
                    `https://whatsapp.com/channel/0029VbBgXTsKwqSKZKy38w2o_ID/POST_ID`
                );
            }
