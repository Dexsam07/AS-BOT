...
> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ BENZO-MD`;
        ...
        const sentMsg = await amon.sendMessage(from, {
            image: { url: thumb },
            caption: caption,
            mentions: [sender]
        }, { quoted: fakevCard });
        ...
        amon.ev.on('messages.upsert', async ({ messages }) => {
            ...
            if (isReply && (text === '1' || text === '2')) {
                try {
                    await amon.sendMessage(from, { react: { text: '⬇️', key: receivedMsg.key } });
                    ...
                    await amon.sendMessage(from, { react: { text: '✅', key: receivedMsg.key } });
