...
> \`0.9\` *- Very lenient detection*`
    ...
    if (isNaN(value) || value < 0.1 || value > 0.9) return await sock.sendMessage(from, { text: "❌ *INVALID VALUE*\n*USE:* Number between 0.1 and 0.9" });
