...
amon({
    ...
    try {
        ...
        // Build menu
        let menu = `
╭─✦「 🤖 ${settings.BOT_NAME || 'BENZO-MD'} 」✦─╮
│ 👤 ᴜsᴇʀ: @${sender.split('@')[0]}
│ ⏰ ᴛɪᴍᴇ: ${time}
│ 📅 ᴅᴀᴛᴇ: ${date} 
│ 🔧 ᴘʀᴇғɪx: ${prefix}
│ 🧩 ᴄᴍᴅs: ${totalCommands}
│ 👑 ᴏᴡɴᴇʀ: ${settings.OWNER_NAME || 'AMON'}
╰─✦──✦
...
`;
        ...
        menu += `> ${settings.DESCRIPTION || 'Powered by AMON'}`;

        // Send menu
        await malvin.sendMessage(
            from,
            {
                image: { url: settings.MENU_IMAGE_URL || 'https://i.ibb.co/R4GM8Yqq/benzomd.jpg' },
                caption: menu,
                contextInfo: {
                    mentionedJid: [sender],
                    forwardingScore: 999,
