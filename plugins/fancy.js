...
Example: ${botPrefix}fancy ${num} ALI MD BOT`
                );
            }
            ...
            if (!map || typeof map !== "object") {
                return reply(`❌ Font ${num} is not available`);
            }
            ...
            try {
                ...
                return reply(`❌ Could not apply font ${num}`);
            }
...
📌 Usage:
• ${botPrefix}fancy ALI MD → show all fonts
• ${botPrefix}fancy 5 ALI MD → specific font with copy button
