        ...
        if (quotedPack && !imageMessage && !stickerMessage && !isDelete) {
            ...
            try {
                ...
                try {
                    ...
                    await react('❌');
                    return reply('❌ Failed to extract sticker pack.');
                }
...
const newPackPublisher =
    ...
    quotedPack.publisher;
                ...
                try {
                    ...
                    await react('❌');
                    return reply('❌ Failed to repack sticker pack.');
                }
...
return sock.sendMessage(from, {
    text: "🛡️ *Anti-Colong pack sent!*"
                ...
                await react('❌');
                return reply(`❌ Anti-colong error: ${err.message}`);
            }
        }
...
Help: \`${botPrefix}spack help\``
        ...
        if (shouldAppend) {
            ...
            } catch { return reply('❌ Failed to download existing pack.'); }
            ...
            try {
                ...
                return reply('❌ Failed to extract pack.');
            }
            ...
            packName = customName || (await getSetting('PACK_NAME')) || 'ALI-MD';
            ...
            try {
                ...
                return reply('❌ Failed to create sticker pack zip.');
            } finally {
