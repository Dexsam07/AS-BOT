...
Bundled branded header image `assets/as-bot-profile.png` default mein use hoti hai. Agar host par external public image use karni ho, `.env` mein `MENU_IMAGE_URL` set karo:
