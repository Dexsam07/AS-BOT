module.exports = {
  ...
  PLUGIN_MANIFEST: process.env.PLUGIN_MANIFEST || './plugins/plugin-manifest.json',
  PLUGIN_LAZY_LOAD: process.env.PLUGIN_LAZY_LOAD !== 'false',
  PLUGIN_LOAD_FALLBACK_EAGER: process.env.PLUGIN_LOAD_FALLBACK_EAGER === 'true',
